...
\clip [rounded corners=10mm] ([xshift =-10.55cm,yshift=-0.25cm]current page.north) rectangle ++(\paperwidth-0.5cm,-4.5cm);
  ...
  \node [anchor=south west, opacity=0.5] at ([yshift=-1cm, xshift=-3cm]box.south west) {
    \includegraphics[width=6cm]{img/om.png} % Adjust the width as necessary
  };
...
\sectsubtitle{Please see my \href{https://scholar.google.com/citations?user=Y5ReiQsAAAAJ&hl=en}{Google Scholar}} A partial list of publications is provided at the end of this CV. \bigskip
